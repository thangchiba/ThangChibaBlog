    ...
    <>
      ...
      <div className="resume">
        <header className="space-y-2 pb-8 pt-6 md:space-y-5">
          ...
          <p className="text-base md:text-lg md:leading-7 text-gray-500 dark:text-gray-100">
            {description}
          </p>
        </header>
        ...
        <main className="gap-12 max-w-screen-xl mx-auto p-3 md:p-8 dark:bg-gray-700 bg-gray-100 my-12 rounded-md md:flex space-y-12 md:space-y-0">
          ...
          <div className="text-gray-900 dark:text-gray-300 leading-6 space-y-5 prose prose-slate grow table-auto border-collapse">
            {children}
          </div>
        </main>
      </div>
